...
public class ResourceManagerConstants {
    ...
    public static final String CREATE_RESOURCE_METRICS_TABLE = "CREATE TABLE IF NOT EXISTS metricstable" +
            ...
            "parallel int,th_id int,id long,th_win double,th_entire double,elapsedtime long,events long," +
            "lat_win long, entire_lat long, m8 long, m9 long, m10 long,m11 long," +
            " m12 long, m13 long, " +
            "m14 long,m15 long , m16 long);" ;
